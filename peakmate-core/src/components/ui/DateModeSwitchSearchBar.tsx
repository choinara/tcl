...
type DateModeSwitchSearchBarProps<TMode extends string> = {
  dateMode: TMode;
  dateModeOptions: readonly TMode[];
  onDateModeChange: (value: TMode) => void;
  rangeModeValue: TMode;
  year: number;
  month: number;
...
export function DateModeSwitchSearchBar<TMode extends string>({
  dateMode,
  dateModeOptions,
  onDateModeChange,
  rangeModeValue,
  ...
  title,
  className,
}: DateModeSwitchSearchBarProps<TMode>) {
